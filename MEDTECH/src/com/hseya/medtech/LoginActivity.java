...
public class LoginActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (flag) {
			...
			VarList.LOGINUSER_ID = loginSetting
					.getString(ConstList.USER_ID, "");
	...
	public void onClick(View v) {
		...
		case R.id.loginBT:
			...
			if (con.isConnectingToInternet()) {
				...
				if (userName.equals("")) {
					Toast.makeText(this, MessageClass.LOGIN_USERNAME_EMPTY,
							Toast.LENGTH_LONG).show();

				} else if (password.equals("")) {
					Toast.makeText(this, MessageClass.LOGIN_PASSWORD_EMPTY,
							Toast.LENGTH_LONG).show();
				...
				Toast.makeText(LoginActivity.this, MessageClass.NO_INTERNET,
						Toast.LENGTH_LONG).show();
			}
	...
	private class PostToServer extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (success == 1) {
				...
				Intent call = new Intent(LoginActivity.this,
						MianMenuActivity.class);
				startActivity(call);
				LoginActivity.this.finish();

			} else {
				Toast.makeText(LoginActivity.this, MessageClass.LOGIN_INVALID,
						Toast.LENGTH_LONG).show();
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				json = userFunction.getLoginValueFunction(VarList.USERNAME,
						VarList.PASSWORD);
